...
![GitHub Repo stars](https://img.shields.io/github/stars/poocong/VidCall?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/poocong/VidCall)
![GitHub pull requests](https://img.shields.io/github/issues-pr/poocong/VidCall)
![GitHub contributors](https://img.shields.io/github/contributors/poocong/VidCall?style=flat)
![GitHub forks](https://img.shields.io/github/forks/poocong/VidCall?style=flat)
...
```sh
git clone https://github.com/poocong/VidCall
cd VidCall
